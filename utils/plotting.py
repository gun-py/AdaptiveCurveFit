"""
Plotting utilities for demand-backup models
"""
import numpy as np
import pandas as pd
...
def plot_fit_3params(df_plot, params, min_demand, max_demand, r2, N, model_func):
    """
    Plot the fitted curve for a bin using the 3-parameter model
...
def plot_fit_2params(df_plot, params, min_demand, max_demand, r2, N, model_func):
    """
    Plot the fitted curve for a bin using the 2-parameter model
...
def plot_parameters_variation_3params(results):
    """
    Plot how parameters a, b, and c vary with demand for 3-parameter model
    
    Parameters:
    -----------
    results : list
        List of dictionaries containing results for each bin
        
    Returns:
    --------
    pandas.DataFrame
        DataFrame with parameters and demand values
    """
    # Extract mean demand values and parameters
...
def plot_parameters_variation_2params(results):
    """
    Plot how parameters a and b vary with demand for 2-parameter model
...
def plot_parameter_relationships(df_params, param_count=3):
    """
    Plot parameter relationships with demand
